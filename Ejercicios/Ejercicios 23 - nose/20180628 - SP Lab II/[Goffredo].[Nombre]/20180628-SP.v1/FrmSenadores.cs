...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        public void ManejadorVoto(string senador, Votacion.EVoto voto)
        {
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    // Guardar resultados
                    SerializarXml<Votacion> file = new SerializarXml<Votacion>();
                    file.Guardar(Environment.GetFolderPath(Environment.SpecialFolder.Desktop)+"\\olis.xml",this.votacion);
        ...
        private void Votacion_EventoVotoEfectuado(string senador, Votacion.EVoto voto)
        {
